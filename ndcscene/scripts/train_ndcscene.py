...
from ndcscene.data.semantic_kitti.params import (
    semantic_kitti_class_frequencies,
    kitti_class_names,
)
from ndcscene.data.NYU.params import (
...
@hydra.main(config_name="../config/ndcscene_kitti.yaml")
def main(config: DictConfig):
    ...
    model = NDCScene(
        ...
        aux_ssc_loss=config.aux_ssc_loss,
        miou_loss=config.miou_loss,
        lr=config.lr,
